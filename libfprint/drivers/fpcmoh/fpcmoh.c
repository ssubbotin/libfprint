...
static void fpcmoh_capture_bulk_cb (FpiUsbTransfer *transfer, FpDevice *dev,
                                     gpointer user_data, GError *error);
static void fpcmoh_tls_handshake_flush_cb (FpiUsbTransfer *transfer, FpDevice *dev,
                                            gpointer user_data, GError *error);
...
static void fpcmoh_process_event (FpDevice *dev, FpiSsm *ssm,
...
static void fpcmoh_capture_process_event (FpDevice *dev, FpiSsm *ssm);
static void fpcmoh_process_tls_data (FpDevice *dev, FpiSsm *ssm);
